	...
	<div class="row">
		<div class="col-md-12">
			...
			<form method="post" onsubmit="return false" id="formChangePass">
				...
				<a href="index.php?view=thongtincanhan">Trở về</a>
				<button class="btn btn-primary" onclick="changePass()" id="submit_change_pass">
					<span class="glyphicon glyphicon-ok">Thay đổi</span>
				</button>
				<br>
				<br>
