...
<?php 
	...
	$proId='';
	if(isset($_GET['tien'])&&isset($_GET['id'])){
		$tien = $_GET['tien'];
		$id = $_GET['id'];
		...
		if($tien==100000)
		{
			$condition = " WHERE price BETWEEN 0 AND 100000 ORDER BY price ASC";
		}
		if($tien==300000)
		{
			$condition = " WHERE price BETWEEN 100000 AND 300000 ORDER BY price ASC";
		}
		if($tien==500000)
		{
			$condition = " WHERE price BETWEEN 300000 AND 500000 ORDER BY price ASC";
		}
		if($tien==500001)
		{
			$condition = " WHERE price >500000 ORDER BY price ASC";
		}
		if($id)
		{
